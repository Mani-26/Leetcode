<h2><a href="https://leetcode.com/problems/decode-the-message/?envType=problem-list-v2&envId=hash-table">2406. Decode the Message</a></h2><h3>Easy</h3><hr><p>You are given the strings <code>key</code> and <code>message</code>, which represent a cipher key and a secret message, respectively. The steps to decode <code>message</code> are as follows:</p>
